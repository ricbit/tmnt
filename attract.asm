...
; ----------------------------------------------------------------
; State: turtles_slide_diff
; Turtle pictures slide and update pictures using diffblit
...
turtles_slide_diff:
        ...
        VDP_STATUS 1
        ENABLE_HIRQ
        NEXT_HANDLE turtles_slide_middle_diff
        QUEUE_MAPPER 14
        ld      hl, (slide_data)
        call    queue_diffblit
        jp      return_irq_exx

turtles_slide_middle_diff:
        ; Order is important!
        PREAMBLE_HORIZONTAL
        DISABLE_SCREEN
        exx
        ...
        HSPLIT_LINE 106
        NEXT_HANDLE turtles_slide_bottom_diff
        ld      a, (vscroll_bottom)
        VDPREG vdp_vscroll
