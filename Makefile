...
OBJECTS = attract.asm handles.inc city1.z5 city2a.z5 city2b.z5 cityline.z5 \
...
city2a.sc5 city2b.sc5: raw/city2.raw
	python tools/gen_city_raw.py $^ city2a.sc5 city2b.sc5
